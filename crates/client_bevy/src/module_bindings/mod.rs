...
pub mod connect_guest_reducer;
pub mod move_self_reducer;
pub mod player_table;
pub mod player_type;
pub mod players_snapshot_table;

pub use connect_guest_reducer::connect_guest;
pub use move_self_reducer::move_self;
pub use player_table::*;
pub use player_type::Player;
pub use players_snapshot_table::*;
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::ConnectGuest { .. } => "connect_guest",
            Reducer::MoveSelf { .. } => "move_self",
            _ => unreachable!(),
        }
    }
    ...
    fn args_bsatn(&self) -> Result<Vec<u8>, __sats::bsatn::EncodeError> {
        match self {
            Reducer::ConnectGuest { guest_name } => {
                __sats::bsatn::to_vec(&connect_guest_reducer::ConnectGuestArgs {
            ...
            Reducer::MoveSelf {
                ...
                direction_y,
                delta_seconds,
            } => __sats::bsatn::to_vec(&move_self_reducer::MoveSelfArgs {
                direction_x: direction_x.clone(),
                direction_y: direction_y.clone(),
                delta_seconds: delta_seconds.clone(),
            }),
            _ => unreachable!(),
        }
    }
...
pub struct DbUpdate {
    ...
    players_snapshot: __sdk::TableUpdate<Player>,
}
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "players_snapshot" => db_update
                    .players_snapshot
                    .append(players_snapshot_table::parse_table_update(table_update)?),
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.players_snapshot =
            cache.apply_diff_to_table::<Player>("players_snapshot", &self.players_snapshot);
...
pub struct AppliedDiff<'r> {
    ...
    players_snapshot: __sdk::TableAppliedDiff<'r, Player>,
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        players_snapshot_table::register_table(client_cache);
    }
    const ALL_TABLE_NAMES: &'static [&'static str] = &["player", "players_snapshot"];
}
